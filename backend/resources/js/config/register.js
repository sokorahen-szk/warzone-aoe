...
export const question2 = [
  { selected: false, label: "前衛 22～23人弓", value: 1},
  { selected: false, label: "前衛 軍平", value: 2},
  { selected: false, label: "前衛 TR", value: 3},
  { selected: false, label: "後衛 22人斥候", value: 4},
  { selected: false, label: "後衛 即城騎士", value: 5},
  { selected: false, label: "後衛 直", value: 6},
  { selected: false, label: "後衛 即ユニーク", value: 7},
]

export const question3 = [
  { selected: false, label: "AOCHD.JP", value: 1},
  { selected: false, label: "ニコ生AOC", value: 2},
  { selected: false, label: "たまひよ、こっこ", value: 3},
  { selected: false, label: "aok予備校", value: 4},
  { selected: false, label: "ブラシス", value: 5},
  { selected: false, label: "SIREN", value: 6},
  { selected: false, label: "JGZ", value: 7},
  { selected: false, label: "IRSJ", value: 8},
]
