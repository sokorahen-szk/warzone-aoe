            ...
            <v-row no-gutters class="py-2">
                    ...
                    <v-row no-gutters>
                        <v-col cols="12">
                            ...
                            <div>
                                ...
                                {{
                                    profile &&
                                        toStringYYYYMM(profile.player.joinedAt)
                                }}
                            </div>
                            <div
                                v-if="
                                    isLogin && playerId == getProfile.player.id
                                "
                                class="text-right"
                            >
                                <Button
                ...
                <v-col cols="12" class="pt-4 pb-2">
                    <GamePackageList
                        ...
                        :hasGamePackages="
                            profile && profile.player.gamePackages
                        "
                    />
                </v-col>
                <v-col cols="12">
