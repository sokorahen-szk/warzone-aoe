            ...
            <v-form ref="form" v-model="valid" lazy-validation>
                ...
                >
                    <v-row v-if="teamDivisionResponse">
                        <v-col cols="6">
                            <div class="py-2 text-center light-blue lighten-4">
                                チーム1
                            </div>
                            <v-list flat>
                                <v-list-item>
                                ...
                                <v-divider />
                                <v-list-item
                                    v-for="data in teamDivisionResponse.team1"
                                    :key="`player-id-${data.id}`"
                                >
                                    <v-list-item-content>
                                        <v-row no-gutters>
                                            <v-col cols="8">{{
                                    ...
                                    <v-list-item-content>
                                        <v-row no-gutters>
                                            ...
                                            <v-col
                                                ...
                                                class="text-center"
                                                >{{
                                                    teamDivisionResponse.team1MuSum
                                                }}</v-col
                                            >
                                        </v-row>
                                    </v-list-item-content>
                        ...
                        <v-col cols="6">
                            ...
                            <v-list flat>
                                ...
                                <v-divider />
                                <v-list-item
                                    v-for="data in teamDivisionResponse.team2"
                                    :key="`player-id-${data.id}`"
                                >
                                    <v-list-item-content>
                                        <v-row no-gutters>
                                    ...
                                    <v-list-item-content>
                                        <v-row no-gutters>
                                            ...
                                            <v-col
                                                ...
                                                class="text-center"
                                                >{{
                                                    teamDivisionResponse.team2MuSum
                                                }}</v-col
                                            >
                                        </v-row>
                                    </v-list-item-content>
                        ...
                        <v-col cols="12">
                            ...
                            <v-row no-gutters>
                                <v-col class="px-2 text-h4" cols="auto"
                                    >良</v-col
                                >
                                <v-col>
                                    <QualityBar
            ...
            switch (mutation.type) {
                ...
                case "gameStore/setPackageList":
                    this.$set(
                        this,
                        "gamePackages",
                        selectParser(this.getPackageList, {
                            label: "name",
                            value: "id"
                        })
                    );
